//#region node_modules/.nitro/vite/services/ssr/assets/pack-Cm0S4oXD.js
var SKILLS = [
	{
		id: "life-db",
		name: "life-db",
...
var TABLES = [
	...
	},
	{
		name: "receipt_claims",
		role: "同一张票的其他人",
		cols: [["person_id + role", "payer | split | viewer"], ["share_cents", "分摊（可空）"]]
	},
	{
		name: "merchants",
		role: "熟店",
...
//#endregion
export { SKILLS as a, RECEIPT_DEMO as i, FLOWS as n, TABLES as o, INSTALL_STEPS as r, ADVICE as t };
